...
# ssl_mos
mos_dir = "/content/drive/My Drive/Speech/So_To_Speak/models/mos_ssl/"
...
class Config:
    def __init__(self):
        # Tacotron
        self.tacotron_checkpoint_path = '/content/drive/My Drive/Speech/So_To_Speak/models/tronduo/'
        self.tacotron_iterations = '70000'
        # prosodic control
        self.prosodic = True
        ...
        # HiFi-GAN
        self.hifigan_checkpoint_path = '/content/drive/My Drive/Speech/So_To_Speak/models/hifigan/'
        self.hifigan_iterations = 2640000
